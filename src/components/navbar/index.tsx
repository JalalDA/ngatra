...
const Header = () => {
  ...
  return (
    <>
      <header
        className={`header left-0 top-0 z-40 flex w-full items-center bg-gray-300 ${sticky
            ? "dark:bg-gray-dark dark:shadow-sticky-dark fixed z-[9999] bg-gray-400 !bg-opacity-80 shadow-sticky backdrop-blur-sm transition"
          ...
          <div className="relative -mx-4 flex items-center justify-between">
            ...
            <div className="flex w-full items-center justify-between px-4">
              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                ...
                <Link
                  href="/register"
                  className="ease-in-up shadow-btn hover:shadow-btn-hover hidden rounded-sm bg-primary px-8 py-3 text-base font-medium text-gray-900 transition duration-300 hover:bg-opacity-90 md:block md:px-9 lg:px-6 xl:px-9"
                >
                  Daftar
                </Link>
              </div>
